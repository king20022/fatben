    ...
    <div class="deznav">
        <div class="deznav-scroll">
            <ul class="metismenu" id="menu">
                ...
                <li><a href="{{ route('user.deposit') }}" class="ai-icon" aria-expanded="false">
                ...
                <li><a href="{{route('user.investment')}}" class="ai-icon" aria-expanded="false">
                ...
                <li><a href="{{route('withdrawal')}}" class="ai-icon" aria-expanded="false">
                        <i class="flaticon-381-networking"></i>
                        <span class="nav-text">Withdrawal Trans</span>
                    </a>
                </li>
